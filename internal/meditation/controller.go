...
type MeditationController struct {
	storage *MediationStorage
}

func NewMeditationController(storage *MediationStorage) *MeditationController {
	return &MeditationController{
		storage: storage,
	}
}
...
func (t *MeditationController) create(c *fiber.Ctx) error {
...
func (t *MeditationController) get(c *fiber.Ctx) error {
